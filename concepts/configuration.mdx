---
title: "ConfigManager"
description: "Understand AgentHeaven's scoped global ConfigManager with fallback, CLI, and version history."
---
...
<Tip>
    **Next reads:**
    - [Configuration overview](/guides/configuration/overview) — setup and operational baseline
    - [Common patterns](/guides/configuration/common-patterns) — app/environment/user scoping patterns
    - [Advanced configuration](/guides/configuration/advanced) — deeper internals and advanced workflows
