---
title: "IMDb Sentiment Analysis: Improving LLM Accuracy with Experience"
sidebarTitle: "IMDb Sentiment Analysis"
description: "A quick walkthrough showing how AgentHeaven uses cached experience to improve LLM sentiment analysis accuracy on the IMDb dataset."
date: "2026-03-30"
...
<Info>
    ✍️ AgentHeaven Team · 📅 March 30, 2026 · 📝 ~800 words · ⏱️ ~4 min read
</Info>
...
Refer to [Quick Setup](/quickstart/quick-setup) for LLM configuration.
...
<Tip>
    **Learn more about the concepts used in this tutorial:**
    - [Caching](/features/caching) — memoization and cache management
    - [Knowledge: UKF](/features/knowledge/ukf) — the Unified Knowledge Format behind ExperienceUKFT
    - [Knowledge: Storage](/features/knowledge/storage) — VectorKLStore and other storage backends
    - [Knowledge: Retrieval](/features/knowledge/retrieval) — VectorKLEngine and semantic search
</Tip>
