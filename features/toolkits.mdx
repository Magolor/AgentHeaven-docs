...
print(restored_add.signature(a=5, b=6))                 # "add(a=5, b=6)"
...
<Tip>
    **Next:**
    ...
    - [MCP Clients](/ecosystem/mcp-clients) — connect toolkits to external MCP clients
    - [Skills](/ecosystem/skills) — the skill protocol and ecosystem
</Tip>
